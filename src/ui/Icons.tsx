/**
 * Iconos reutilizables para botones y acciones.
 * SVG inline para no depender de exports de lucide-react en build.
 */
...
export function IconTrash2(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
